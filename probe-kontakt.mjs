...
const projectRoot='/tmp/probe-project'; const db='/tmp/probe-app2.sqlite3';
...
const env={...process.env,DATABASE_PATH:db,ADMIN_PASSWORD:'x',NEXT_PUBLIC_APP_URL:base,NODE_ENV:'production',SESSION_COOKIE_NAME:'probe_s2',E2E_INSECURE_COOKIES:'1'};
...
console.log('role-count:', await page.getByRole('link',{name:'Anliegen starten'}).count());
const href=await page.getByRole('link',{name:'Anliegen starten'}).first().getAttribute('href');
console.log('href:', href);
await page.getByRole('link',{name:'Anliegen starten'}).click();
await page.waitForTimeout(2000);
console.log('after click URL:', page.url());
console.log('h2 text:', await page.locator('h2').allInnerTexts().catch(()=>[]));
