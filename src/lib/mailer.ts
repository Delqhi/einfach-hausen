...
export const mailTemplates = {
  neuesAngebotFuerOwner: (firma: string, titel: string, preis: number, anfrageId: string) => `
    <div style="font-family:Helvetica,Arial,sans-serif;max-width:520px;margin:auto">
      ...
      <a href="${APP_URL()}/anfrage/${anfrageId}" style="display:inline-block;background:#14735c;color:#fff;padding:14px 28px;border-radius:14px;text-decoration:none;font-weight:800;margin-top:16px">Angebot ansehen</a>
  ...
  neueAnfrageFuerPro: (titel: string, plz: string, ort: string, dringend: boolean, anfrageId: string) => `
    <div style="font-family:Helvetica,Arial,sans-serif;max-width:520px;margin:auto">
      ...
      <a href="${APP_URL()}/anfrage/${anfrageId}" style="display:inline-block;background:#14735c;color:#fff;padding:14px 28px;border-radius:14px;text-decoration:none;font-weight:800;margin-top:16px">Anfrage ansehen & Angebot senden</a>
