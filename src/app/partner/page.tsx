...
export default function Page(){return <MarketingShell>
  ...
  <Section eyebrow="Qualitätsnetzwerk" title="Nicht jeder Eintrag wird automatisch Partner." text="Vor aktiver Vermittlung sieht das Produktmodell eine Mindestprüfung und einen aktiven Partnervertrag vor." tone="soft">
  ...
  <Section eyebrow="Team" title="Ein Firmenkonto. Mehrere Menschen. Eine zentrale Berechtigung." text="Das Partnerprodukt soll in wenigen Minuten verständlich sein und bewusst keine komplexe Rollenmatrix aufbauen." tone="green">
