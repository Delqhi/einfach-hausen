...
export default function Page(){return <MarketingShell>
  <PageHero eyebrow="Für Eigenheimbesitzer" title="Dein Haus hat viele Themen. Du brauchst trotzdem nur eine Eingangstür." text="Von der ersten Frage bis zur Rechnung: Einfach Hausen hält den Vorgang verständlich zusammen und bewahrt das Wissen danach in deiner Hausakte." aside={<HeroEditorialPhoto src="/images/premium/hero-homeowner.jpg" label="Eine Anlaufstelle fürs Eigenheim" detail="Fragen, Aufträge und Hauswissen bleiben verbunden." />} actions={<LinkButton href="/register?role=homeowner">Kostenlos starten</LinkButton>} />
