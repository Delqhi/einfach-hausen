  ...
  return (
    <MarketingShell>
      ...
      <EHScope>
        ...
        <EHClosing title="Beschreib einfach, was ansteht." text="Kostenlos, unverbindlich, in deinen Worten. Die Zuordnung ist unser Job." href="/#anliegen" label="Anliegen starten" />
      </EHScope>
    </MarketingShell>
  );
}
