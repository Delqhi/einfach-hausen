...
import { BulletList, CtaBand, Faq, LinkButton, PageHero, Section, Statement, Steps, Timeline, mkt as styles } from '@/components/marketing/ui';
import { Clauses, FaqFrame, IndexList } from '@/components/marketing/archetypes';

// UI-Convergence Welle 2: Die Seite hatte zwei identische Feature-Kartenraster
// ("Drei Wege" und "Matching") direkt hintereinander. Beide sind jetzt
// eigene Formen: Paragraphen-Klauseln für die drei Wege, ein Index für das
// Matching. Hero, Schritte und der echte Wochenverlauf bleiben, die tragen
// die Seite.
...
export default function Page() {
  return (
    <MarketingShell>
        ...
        items={[
          {
            ...
            body: <p>Zuerst verstehen, was wahrscheinlich sinnvoll ist. Dabei entsteht kein Auftrag, es fällt keine Gebühr an und niemand ruft dich ungefragt an. Du kannst nach der Antwort einfach aufhören.</p>,
          },
          {
            title: 'Einen Menschen sprechen',
            body: <p>Ein passender geprüfter Partner wird als konkreter Ansprechpartner verbunden, auch ohne Buchung. Zum Beispiel, um eine Einschätzung vor Ort zu bekommen oder zu klären, ob sich eine Reparatur überhaupt lohnt.</p>,
          },
          {
            title: 'Erledigen lassen',
            body: <p>Wenn du willst, dass es gemacht wird, vervollständigen wir die Auftragsdaten, holen Kostenrahmen und Termin ein, und du gibst frei. Erst diese Freigabe macht aus einem Anliegen einen Auftrag.</p>,
          },
        ]}
      />
      ...
      <IndexList
        eyebrow="Matching"
        title="Passend schlägt laut."
        note="Bei der Auswahl zählen fachliche Eignung, Region, Verfügbarkeit, Kapazität und Kundenzufriedenheit. Ein Partner-Tarif kann die Reihenfolge nicht kaufen."
        items={[
          { icon: <ShieldCheck size={18} aria-hidden="true" />, title: 'Geprüft und vertraglich gebunden', text: 'Partner werden vor der ersten Vermittlung persönlich geprüft und verpflichten sich auf unsere Regeln.' },
          { icon: <UserRound size={18} aria-hidden="true" />, title: 'Beziehungen zählen', text: 'Hat ein Partner schon bei dir gearbeitet und es lief gut, bevorzugen wir ihn beim nächsten passenden Anliegen.' },
          { icon: <Wrench size={18} aria-hidden="true" />, title: 'Ein Vorgang, alles drin', text: 'Angebot, Termin, Nachrichten, Dokumente, Rechnung und Status gehören zusammen, nicht in fünf Chats und drei Postfächer.' },
        ]}
      />
      ...
      <FaqFrame
        ...
        text={<>Wie wir Partner prüfen, steht auf <a href="/sicherheit">Sicherheit und Daten</a>.</>}
      >
        <Faq items={[
