...
export default function NotFound() {
  // Die drei dringlichsten Begriffe als Einstieg — statt einer leeren Sackgasse.
  const vorschlaege = [...LEXIKON_EINTRAEGE].sort((a, b) => b.stufen.dringlichkeit - a.stufen.dringlichkeit).slice(0, 3);
  return (
    <MarketingShell>
