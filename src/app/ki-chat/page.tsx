...
export default function KiChatPage() {
  ...
  return (
    <div className="safe-top safe-bottom page ki-page">
      <header className="ob-header"><button className="back-btn" onClick={() => router.back()}><BackIcon /></button><div className="ki-robot" style={{ margin: "0 auto" }}><svg width="44" height="44" viewBox="0 0 64 64" fill="none"><circle cx="32" cy="10" r="4" fill="#16333d" /><path d="M32 14v6" stroke="#16333d" strokeWidth="3" strokeLinecap="round" /><rect x="14" y="20" width="36" height="28" rx="10" fill="#fff" stroke="#16333d" strokeWidth="3" /><circle cx="25" cy="33" r="3.2" fill="#16333d" /><circle cx="39" cy="33" r="3.2" fill="#16333d" /><path d="M26 40c2 2.5 10 2.5 12 0" stroke="#16333d" strokeWidth="2.4" strokeLinecap="round" /></svg></div><span style={{ width: 20 }} /></header>
