...
export function HausmeisterComposer({continuingIntent,starterHint}:{continuingIntent?:'service'|'contact'|null;starterHint?:string}){
  ...
  return <form action={sendHausmeisterAction} className="agent-composer">
    ...
    <div className="agent-actions">
      <label className="icon-action" title="Foto, Video oder Sprachnachricht hinzufügen"><Camera size={19}/><span>Medien</span><input name="photo" type="file" accept="image/*,video/mp4,video/webm,video/quicktime,video/x-m4v,audio/aac,audio/mpeg,audio/mp4,audio/ogg,audio/opus,audio/wav,audio/x-wav"/></label>
