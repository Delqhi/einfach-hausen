...
export function HausmeisterComposer(){
  ...
  return <form action={sendHausmeisterAction} className="agent-composer">
    <textarea name="description" value={text} onChange={e=>setText(e.target.value)} rows={3} required placeholder="Sag einfach, was dein Haus braucht … z. B. „Meine Hecke muss Dienstag ab 14 Uhr geschnitten werden.“"/>
    <div className="agent-actions">
      ...
      <button className="send-action" type="submit" disabled={text.trim().length<4}><Send size={18}/><span>Hausmeister beauftragen</span></button>
    </div>
  </form>;
}
