...
**Status snapshot:** 2026-08-27 — **HA Produktion aktiv: Supabase Postgres+Storage = Primary, Capacitor iOS/Android = Produktionspfad, SQLite nur Fallback.** Vorheriger Cutover `dcd53ca1f463e9d64ee3fc6838d1cdb3fb2bb557` bleibt Baseline vor HA-Migration (T-0166/T-0167).
