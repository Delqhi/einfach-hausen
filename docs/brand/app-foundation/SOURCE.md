...
Basiscommit: a90d411. Pfade relativ zu diesem Repository. Dateien vollständig, keine Auslassungszeichen. Binärdateien werden im Manifest mit SHA256 referenziert. Dieses Dokument ist ein Nachschlagewerk; implementiert wird aus den versionierten Quelldateien.
...
`````json
{
  ...
  "files": {
    ...
    "packages/eh-design/src/index.ts": "3b85a8cfb9d19bf4c06df793596ac3e357f9aff9b2c208d0e836d60a231258a6",
...
## docs/brand/app-foundation/NEXT_AGENT.md
...
## packages/eh-design/src/submit-button.tsx
...
## packages/eh-design/src/workflow-layouts.tsx
